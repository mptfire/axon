...
| 2 | [AI subscription setup](phase-2-ai-subscription-setup.md) | **Headline:** natural-language subscription wizard in web app + `/v1/ai/plan` | 1 | M | 🔧 ~80%: server + subscribe assistant landed; tune UI & refinement chat pending |
