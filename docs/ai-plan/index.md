...
| 5 | [Chat with your notifications](phase-5-chat-with-notifications.md) | Conversational Q&A / search over history (streaming) | 1 | M | 🔧 Cited multi-turn Q&A per topic AND cross-topic (`/v1/ai/chat`, `all: true`) + web dialog + MCP `ask_history`; SSE streaming & embeddings pending |
