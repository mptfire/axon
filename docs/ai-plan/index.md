...
| 4 | [Digests & briefings](phase-4-digests-briefings.md) | Scheduled AI digests per user | 3 | M | ✅ Complete: on-demand digest + cross-topic briefing + **scheduled daily briefings** (prefs.digest, UTC hour, private dg_ topics with read ACL; timezone picker pending) |
