...
Cloud providers (`openai`, `anthropic`, or any `openai-compatible` endpoint such as OpenRouter/vLLM)
...
| `ai-provider`                              | `NTFY_AI_PROVIDER`                              | *string*                                            | -                 | AI: Provider, one of `openai`, `anthropic`, `openai-compatible`, `ollama`, `mock`. Required if `ai-enabled` is set.                                                                                                                      |
...
OPTIONS:
   ...
   --ai-cache-size value, --ai_cache_size value                                                                                   size of the AI response cache in bytes (default: "104857600") [$NTFY_AI_CACHE_SIZE]
   --help, -h                                                                                                                     show help
```
